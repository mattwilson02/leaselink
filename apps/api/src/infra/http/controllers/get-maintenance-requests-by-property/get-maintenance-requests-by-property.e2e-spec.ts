...
describe('GetMaintenanceRequestsByPropertyController (E2E)', () => {
	...
	it('[GET] /properties/:propertyId/maintenance-requests - should return requests for property', async () => {
		...
		const response = await request(app.getHttpServer())
			.get(`/properties/${propertyId}/maintenance-requests`)
			.set({
	...
	it('[GET] /properties/:propertyId/maintenance-requests - should reject CLIENT auth', async () => {
