...
import {
	...
	useOnboardingSetPasswordControllerHandle,
} from '@/gen/index'
...
const EnableBiometrics = () => {
	...
	const { mutateAsync } = useOnboardingSetPasswordControllerHandle()
		...
		try {
			...
			await editClientStatus({
				...
				data: {
					...
					status: unifiedUserDTOStatusEnum.ACTIVE,
					onboardingStatus: unifiedUserDTOOnboardingStatusEnum.ONBOARDED,
					deviceId,
				},
			})
