...
const NotificationSkeleton = ({ numberOfSkeletons = 3 }) => {
	...
	const SkeletonItem = () => (
		<View style={styles.skeletonContainer} testID='notification-skeleton'>
...
const styles = StyleSheet.create({
	...
	skeletonContainer: {
		...
		marginBottom: 8,
		height: 68, // Height of a notification item
		overflow: 'hidden',
	},
	leftContent: {
		flexDirection: 'row',
...
const NotificationsListSkeleton = () => {
	return <NotificationSkeleton numberOfSkeletons={7} />
}
