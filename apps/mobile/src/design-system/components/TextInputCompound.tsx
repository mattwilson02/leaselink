...
const TextInputRoot = ({ style, children, disabled, testID }: TextInputRootProps) => {
  return <View style={[styles.root, style, disabled && styles.disabled]} testID={testID}>{children}</View>
}
