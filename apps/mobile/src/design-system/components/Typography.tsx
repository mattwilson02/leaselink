...
const weightMap: Record<FontWeight, { fontFamily: string; fontWeight: '400' | '500' | '600' | '700' }> = {
...
export const Text = ({ size = 'base', fontWeight = 'regular', style, ...props }: TextProps) => {
...
const headingSizeMap: Record<HeadingSize, { fontSize: number; lineHeight: number }> = {
...
export const Heading = ({ size = 'h5', fontWeight = 'bold', style, ...props }: HeadingProps) => {
